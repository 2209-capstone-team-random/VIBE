...
const UserCard = ({ user }) => {
  ...
  return (
    <Link to={`/profile/${user.userSpotify}`}>
      <div className="shadow-xl gap-3 p-4 m-4 mb-10 w-[200px] h-[250px] bg-opacity-80 backdrop-blur-sm rounded-lg cursor-pointer bg-blue-100 hover:bg-blue-200 dark:bg-gray-600 dark:hover:bg-gray-500">
        ...
        <div className="mt-4 dark:text-white/90 flex flex-col ">
